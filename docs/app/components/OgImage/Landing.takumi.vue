...
const TAGLINE =
  "Thirty-three blockchains as classes: chain IDs, CAIP-2, coin types, explorers and address checks that decode. Library, CLI, MCP, Pi and OMP.";

const { name: siteName } = useSiteConfig();

const CHAINS = ["Ethereum", "Bitcoin", "Solana", "Cardano", "TON"];
</script>
      ...
      <div class="flex items-center">
        <div
          ...
          :style="{
            ...
            color: index === 0 ? '#a5b4fc' : '#a5b0bc',
            backgroundColor: '#11141a',
            border: index === 0 ? '1px solid rgba(165, 180, 252, 0.5)' : '1px solid #262c35',
            lineHeight: '36px',
          }"
        >
          {{ chain }}
