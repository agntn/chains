  ...
  <div class="chains-landing not-prose">
    ...
    >
      ...
      <p class="chains-enter chains-enter-2 mx-auto mt-6 max-w-xl text-base leading-7 text-muted">
        Thirty-five blockchains as classes, one file each: chain ID, CAIP-2, coin type, decimals,
    ...
    <LandingFeature
      eyebrow="Chains"
      title="Thirty-five chains, eleven families"
      to="/chains"
      link="All chains"
      :checks="[
        'Fourteen EVM chains that share one address format and one coin type, 60',
        'Eleven UTXO chains, and a UTXO heritage doesn\'t mean Bitcoin\'s encoding: CashAddr, CIP-19, two version bytes on Decred',
