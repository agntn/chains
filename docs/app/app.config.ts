export default defineAppConfig({
  ...
  seo: {
    title: "@agntn/chains",
    description:
      "Canonical blockchain classes for 35 chains: chain IDs, CAIP-2, coin types, explorers and address validation that decodes. Library, CLI, MCP server, Pi and OMP.",
    schema: {
  ...
  ui: {
      ...
      compoundVariants: [
        {
          color: "primary",
          variant: "solid",
          class: "chains-primary-fill ring-0",
        },
        {
          color: "neutral",
          variant: "outline",
          class: "chains-neutral-outline ring-0",
        },
      ],
    },
    pageHeader: {
    ...
    contentSurround: {
      slots: {
        link: "rounded-xl chains-frame border-0 bg-default hover:bg-muted",
