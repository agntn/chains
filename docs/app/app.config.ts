export default defineAppConfig({
  ...
  seo: {
    title: "@agntn/chains",
    description:
      "Canonical blockchain classes for 31 chains: chain IDs, CAIP-2, coin types, explorers and address validation that decodes. Library, CLI, MCP server, Pi and OMP.",
    schema: {
