...
A bare [Bitcoin Cash](/chains/bitcoincash) address fails here on purpose. It differs from its eCash twin in the checksum alone, and the checksum is exactly what is verified. Legacy base58 addresses aren't accepted at all, the bytes are the same as Bitcoin's and would say nothing about eCash.
