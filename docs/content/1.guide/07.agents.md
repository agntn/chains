...
title: Agents
icon: i-lucide-bot
description: The same four tools over MCP and the Pi and OMP extensions. What the text carries and what sets isError. What a model can't hand the process.
---
