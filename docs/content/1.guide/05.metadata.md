...
| --- | ---: | --- |
| Ethereum, Base, Arbitrum, Optimism, Polygon, BNB Chain, Avalanche C-Chain, Fantom, Gnosis, Linea, zkSync, Scroll, Berachain | 18 | [`ethereum-lists/chains`](https://github.com/ethereum-lists/chains/tree/master/_data/chains), `nativeCurrency.decimals` in `eip155-{1,8453,42161,10,137,56,43114,250,100,59144,324,534352,80094}.json` |
